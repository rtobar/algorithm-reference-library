...
def coalesce_visibility(vis: BlockVisibility, time_coal=0.0, frequency_coal=0.0, max_time_coal=100,
                        max_frequency_coal=100) -> Visibility:
    ...
    cvis, cuvw, cwts, ctime, cfrequency, cchannel_bandwidth, ca1, ca2, cintegration_time, cindex \
        = average_in_blocks(vis.data['vis'], vis.data['uvw'], vis.data['weight'], vis.time, vis.integration_time,
                            vis.frequency, vis.channel_bandwidth, time_coal=time_coal, max_time_coal=max_time_coal,
                            frequency_coal=frequency_coal, max_frequency_coal=max_frequency_coal)
...
def decoalesce_visibility(vis: Visibility, overwrite=False, arl_config='arl_config.ini') -> BlockVisibility:
